(function () {
    ...
    module.config(function (EntityModelConfigProvider, ngBreeze) {
        ...
        function initialize(metadataStore) {
            ...
            var appInfoInitializer = function (obj) {


            };

            metadataStore.setEntityTypeForResourceName('AppInfo', 'AppInfo');
            metadataStore.registerEntityTypeCtor("AppInfo", AppInfo, appInfoInitializer);
